...
function buildShopFromApk() {
  ...
  return {
    ...
    hooks: [
      { id: 'hook1', name: 'Крючок №8', icon: '🪝', iconKey: 'hook-single', level: 1, price: 10, currency: 'silver', bonus: 0, qty: 10 },
      { id: 'hook2', name: 'Крючок №6', icon: '🪝', iconKey: 'hook-heavy', level: 3, price: 35, currency: 'silver', bonus: 0.04, qty: 8 },
      { id: 'hook3', name: 'Тройник №6', icon: '🪝', iconKey: 'hook-treble', level: 6, price: 120, currency: 'silver', bonus: 0.1, qty: 5 },
      { id: 'hook4', name: 'Крючок №14', icon: '🪝', iconKey: null, iconPending: true, level: 1, price: 8, currency: 'silver', bonus: 0, qty: 12 },
      { id: 'hook5', name: 'Крючок №10', icon: '🪝', iconKey: null, iconPending: true, level: 2, price: 15, currency: 'silver', bonus: 0.02, qty: 10 },
      { id: 'hook6', name: 'Офсет №8', icon: '🪝', iconKey: null, iconPending: true, level: 3, price: 40, currency: 'silver', bonus: 0.05, qty: 8 },
      { id: 'hook7', name: 'Круглый №12', icon: '🪝', iconKey: null, iconPending: true, level: 2, price: 18, currency: 'silver', bonus: 0.03, qty: 10 },
    ],
    lines: [
      { id: 'line1', name: 'Леска 0.10 мм', iconKey: null, iconPending: true, level: 1, price: 10, currency: 'silver', bonus: 0, qty: 50 },
      { id: 'line2', name: 'Леска 0.14 мм', iconKey: 'line', level: 1, price: 15, currency: 'silver', bonus: 0.02, qty: 50 },
      { id: 'line3', name: 'Леска 0.18 мм', iconKey: null, iconPending: true, level: 3, price: 35, currency: 'silver', bonus: 0.04, qty: 40 },
      { id: 'line4', name: 'Леска 0.22 мм', iconKey: null, iconPending: true, level: 5, price: 70, currency: 'silver', bonus: 0.06, qty: 30 },
      { id: 'line5', name: 'Плетёнка 0.12', iconKey: null, iconPending: true, level: 4, price: 90, currency: 'silver', bonus: 0.05, qty: 25 },
    ],
    bait: [
      ...
      { id: 'bait7', name: 'Кукуруза', iconKey: 'bait-corn', level: 2, price: 28, currency: 'silver', bonus: 0.05, qty: 10 },
      { id: 'bait8', name: 'Живец', iconKey: 'bait-minnow', level: 3, price: 45, currency: 'silver', bonus: 0.06, qty: 8 },
      { id: 'bait9', name: 'Горох', iconKey: null, iconPending: true, level: 2, price: 22, currency: 'silver', bonus: 0.04, qty: 10 },
      { id: 'bait10', name: 'Кастер', iconKey: 'bait-caster', level: 3, price: 32, currency: 'silver', bonus: 0.05, qty: 10 },
      { id: 'bait11', name: 'Муха', iconKey: 'bait-fly', level: 2, price: 18, currency: 'silver', bonus: 0.04, qty: 10 },
      { id: 'bait12', name: 'Личинка майского', iconKey: 'bait-maybug', level: 4, price: 55, currency: 'silver', bonus: 0.07, qty: 8 },
    ],
    groundbait: [
