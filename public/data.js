...
function buildShopFromApk() {
  ...
  return {
    ...
    bait: [
      ...
      { id: 'bait7', name: 'Кукуруза', iconKey: null, iconPending: true, level: 2, price: 28, currency: 'silver', bonus: 0.05, qty: 10 },
      { id: 'bait8', name: 'Живец', iconKey: null, iconPending: true, level: 3, price: 45, currency: 'silver', bonus: 0.06, qty: 8 },
      { id: 'bait9', name: 'Горох', iconKey: null, iconPending: true, level: 2, price: 22, currency: 'silver', bonus: 0.04, qty: 10 },
      { id: 'bait10', name: 'Кастер', iconKey: null, iconPending: true, level: 3, price: 32, currency: 'silver', bonus: 0.05, qty: 10 },
      { id: 'bait12', name: 'Личинка майского', iconKey: null, iconPending: true, level: 4, price: 55, currency: 'silver', bonus: 0.07, qty: 8 },
    ],
    groundbait: [
