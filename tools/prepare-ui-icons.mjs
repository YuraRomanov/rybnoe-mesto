...
const ICONS = [
  ['c__Users_User_AppData_Roaming_Cursor_User_workspaceStorage_empty-window_images__________-5f525d07-2d10-4956-bcda-4d4ecab8d2dc.png', 'settings'],
  ['c__Users_User_AppData_Roaming_Cursor_User_workspaceStorage_empty-window_images________-12bc0b28-bcc9-42e4-93bc-caaec629e5ef.png', 'shop'],
];
...
async function processIcon(srcFile, outName) {
